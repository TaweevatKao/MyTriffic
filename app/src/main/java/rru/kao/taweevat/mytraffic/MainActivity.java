...
public class MainActivity extends AppCompatActivity {
    ...
    private void listViewController() {
        ...
        final int[] iconInts = {R.drawable.traffic_01, R.drawable.traffic_02,
                ...
                R.drawable.traffic_18, R.drawable.traffic_09, R.drawable.traffic_20};
        ...
        titleStrings[9] = "หัวข้อที่ 11";
        titleStrings[10] = "หัวข้อที่ 12";
        titleStrings[11] = "หัวข้อที่ 13";
        ...
        //For Detail
        String[] detaailStrings = getResources().getStringArray(R.array.detail_short);

        //Create LiseView
        MyAdapter objMyAdapter = new MyAdapter(MainActivity.this, iconInts, titleStrings, detaailStrings);
